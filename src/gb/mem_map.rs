...
const CARTRIDGE_BANK_LENGTH: u16 = 0x4000;

const CARTRIDGE_BANK0_START: u16 = 0x0000;
const CARTRIDGE_BANK0_END: u16 = CARTRIDGE_BANK0_START + CARTRIDGE_BANK_LENGTH - 1;

const CARTRIDGE_BANKN_START: u16 = 0x4000;
const CARTRIDGE_BANKN_END: u16 = CARTRIDGE_BANKN_START + CARTRIDGE_BANK_LENGTH - 1;
